            ...
            <form class="form-horizontal" action="<?php echo base_url('Mainpage/signupAction'); ?>" method="post" id="loginForm">
              <fieldset class="fieldset">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-3">
                    <input type="text" class="form-control" id="miname" name="miname" placeholder="M.I" autocomplete="off" />
                    <br />
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-xs-3">
                    <input type="text" class="form-control" id="birthdate" name="birthmonth" placeholder="Month" />
                </div>
                <div class="col-xs-3">
                    <input type="tel" class="form-control" id="birthdate" name="birthdate" placeholder="Date" />
                </div>
                <div class="col-xs-3">
                    <input type="tel" class="form-control" id="birthdate" name="birthyear" placeholder="Year" />
                    <br />
                </div>
                </div>
                <div class="form-group">
