      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a id="h21"><span style="font-size:30px; cursor:pointer" onclick="openNav()">Log In</span></a></li>
...
<!-- LOGIN SECTION -->
<div id="myNav" class="overlay" style="z-index: 1002">
...
<!-- Section: intro -->
    ...
    <section id="service" class="home-section text-center">
        ...
        <div class="row">
        	<div class="col-md-12">
						<br>
						<a href="recipes.html" class="btn btn-primary" > View Categories</a>
